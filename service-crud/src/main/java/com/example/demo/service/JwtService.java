...
public class JwtService {
    ...
    private String SECRET_KEY="fe60f199041040557dc61317117ad37f10d2352cc8f3ccc32abb11056f6a864b";

    private int expirationTime = 200000;

    private int refreshTime = 23123132;
